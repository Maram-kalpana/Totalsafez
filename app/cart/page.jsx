      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        {!cart.length ? (
          <div className="mt-8 border border-[#ececec] p-8 text-center">
            ...
            <Link
              href="/products"
              className="mt-4 inline-block border border-[#111] px-6 py-2 text-sm uppercase"
            >
              Continue Shopping
            </Link>
          </div>
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_320px]">
            ...
            <div className="space-y-4">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="grid items-center gap-4 border border-[#ececec] p-4 sm:grid-cols-[90px_1fr_auto_auto]"
                >
                  <img
                    src={item.image}
                    alt={item.name}
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#5f9d35]">
                      {item.price}
                    </p>
                  </div>
            ...
            <div className="h-fit border border-[#ececec] p-5">
              ...
              {/* ✅ FIXED BUTTON */}
              <Link href="/checkout">
                <button className="mt-5 w-full bg-black px-4 py-3 text-xs font-semibold uppercase tracking-wider text-white">
                  Proceed to Checkout
                </button>
              </Link>
            </div>
